...
<body>
	...
	<div id="searchOrderTb" style="padding:2px 5px;">
		<form id="searchOrderForm">
			...
			<div style="padding:3px">
				客户名称&nbsp;<input style="width:115px;" id="search_uid" class="easyui-combobox" value="0" name="search_uid" data-options="valueField:'id',textField:'userName',url:'userinfo/getValidUser'" />&nbsp;&nbsp;&nbsp;
